# ANW Bronhouder Capability Statement v1.1.0 - Netherlands - ANW implementation guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ANW Bronhouder Capability Statement v1.1.0**

## CapabilityStatement: ANW Bronhouder Capability Statement v1.1.0 

| | |
| :--- | :--- |
| *Official URL*:http://nuts-foundation.github.io/nl-generic-anw-ig/CapabilityStatement/ANW-Bronhouder | *Version*:1.1.0 |
...
Version 1.0 capability statement defining the basic requirements for ANW FHIR servers wanting to support the ANW-Bronhouder usecase. 
 ...
 [Raw OpenAPI-Swagger Definition file](ANWBronhouderCapabilityStatement-v1.1.0.openapi.json) | [Download](ANWBronhouderCapabilityStatement-v1.1.0.openapi.json) 
...
```json
{
  ...
  "id" : "ANWBronhouderCapabilityStatement-v1.1.0",
  ...
  "rest" : [{
    ...
    {
      "type" : "ChargeItem",
      "profile" : "http://nuts.nl/fhir/StructureDefinition/nl-time-charge-item",
      "interaction" : [{
        "code" : "create"
      }]
    },
